...
<form id="head1" action="pageList" method="get">
    ...
    <a id="btn_query" class="btn btn-primary btn-mini sub" href="javascript:void(0);">查询</a>
</form>
<div id="u2">
...
<script type="text/javascript">
    $(function(){
        $("#table").bootstrapTable({
            url: 'http://localhost/html/page', //请求后台的URL（*）
            ...
            dataLevel:2,
            columns: [
                {field: 'id',title: '<input type="checkbox" id="selectAll">全选/反选',align: "center",formatter:function(value,row,index) {return '<input value="'+value+'" att-email="'+row.email+'" type="checkbox" name="selectedItems" class="toRecoveryButton"/>';}},
                {field: 'id',title: 'id',align: "center"},
                {field: 'customName',title: '客户名称',align: "center"},
                {field: 'bossName',title: '法人代表',align: "center"},
                {field: 'regDatetime',title: '注册时间',align: "center"},
                {field: 'customTypeName',title: '类型',align: "center"},
                {field: 'customStatus',title: '状态',align: "center",formatter:function(value,row,index) {return statusCommom(value)}}
            ]
        });

...
<header class="Hui-header cl">
	...
	<ul class="Hui-userbar">
		<li class="dropDown dropDown_hover"><a href="javascript:" class="dropDown_A">
			<s:property value="#session.user.userName"/>  <i class="icon icon-chevron-sign-down"></i></a>
...
<aside class="Hui-aside sidebar">
	<nav class="menu" data-toggle="menu" style="width: 200px">
		<ul class="nav nav-primary">
			<li class="nav-parent"><a href="javascript:;"><i class="icon-list-ul"></i>客户管理</a>
				<ul class="nav" id="c_1">
					<li id="i2"><a href="pageList" target="inside">企业客户管理</a></li>
				</ul>
			</li>
			<li class="nav-parent"><a href="javascript:;"><i class="icon icon-sitemap"></i>客户申请管理</a>
				<ul class="nav" id="c_2">
					<li id="i1"><a href="keywords_application" target="inside">续租申请</a></li>
					<li id="i10"><a href="keywordsCheck" target="inside">申请审核</a></li>
					<li id="i4"><a href="keywordsList" target="inside">申请列表</a></li>
					<li id="i3"><a href="prepay" target="inside">申请预付款</a></li>
				</ul>
			</li>
